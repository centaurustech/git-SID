...
*/
	...
	$lookups = array(   
		...
		'companies' => array(   
			...
			'sic_code' => array(
				'parent_table' => 'sic',
				'parent_pk_field' => 'sic_id',
				'parent_caption' => 'IF(CHAR_LENGTH(`sic`.`code`) || CHAR_LENGTH(`sic`.`activity`), CONCAT_WS(\'\', `sic`.`code`, \' - \', `sic`.`activity`), \'\')',
				'parent_from' => '`sic` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
		...
		'reports' => array(   
			'company' => array(
				...
				'parent_caption' => 'IF(CHAR_LENGTH(`companies`.`name`) || CHAR_LENGTH(`companies`.`client`), CONCAT_WS(\'\', `companies`.`name`, \' - \', IF(    CHAR_LENGTH(`clients1`.`name`), CONCAT_WS(\'\',   `clients1`.`name`), \'\')), \'\')',
				'parent_from' => '`companies` LEFT JOIN `clients` as clients1 ON `clients1`.`client_id`=`companies`.`client` LEFT JOIN `sic` as sic1 ON `sic1`.`sic_id`=`companies`.`sic_code` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'entries' => array(   
			...
			'outcome_area' => array(
				...
				'parent_caption' => 'IF(    CHAR_LENGTH(`outcome_areas1`.`name`), CONCAT_WS(\'\',   `outcome_areas1`.`name`), \'\')',
			...
			'beneficiary_group' => array(
				...
				'parent_caption' => '`beneficiary_groups`.`name`',
				'parent_from' => '`beneficiary_groups` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'outcomes' => array(   
			'outcome_area' => array(
				'parent_table' => 'outcome_areas',
				'parent_pk_field' => 'outcome_area_id',
				'parent_caption' => '`outcome_areas`.`name`',
				'parent_from' => '`outcome_areas` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
